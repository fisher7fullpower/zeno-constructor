...
| Файл | Переменные |
|------|-----------|
| `/etc/proxy-constructor.env` | REPLICATE_TOKEN, HOMEDESIGNS_TOKEN, GROQ_API_KEY, RESEND_KEY, FROM_EMAIL, JWT_SECRET |
...
| HomeDesigns.ai | Interior renders | proprietary |
